...
# Set verbose mode
verbose = False
PREFIX = "[ titanOSX Report Gen ]"

def header():
    return unicode("""
<html>
<head>
    <title>titanOSX - Report</title>
    <style>
/*!
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">titanOSX Report</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a class="nav_monitor" name="dashboard" href="#">Overview</a></li>
            {{MODULES}}
          </ul>
        </div>
...
def run(argv):
        ...
        for row in module_data:
            ...
            for column in row:
                if column == "name":
                    ...
                    report += "\t</tr>\n"                    
                    report += "</thead>"
                elif column.startswith("_") == False:
                    report += "\t<tr>\n"
                    report += "\t\t<td>\n"
                    report += column
                    report += "\t\t</td>\n"
    ...
    f.write( report.replace("{{MODULES}}", module_sidebar) )
